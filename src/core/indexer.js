  ...
  for (const entry of entries) {
    ...
    if (entry.isDirectory()) {
      ...
      const BLOCKED_FOLDERS = [
        ...
        '__pycache__', '.cache', 'Library',
        'System', 'private', 'proc', 'dev'
      ]
      if (!entry.name.startsWith('.') && !BLOCKED_FOLDERS.includes(entry.name)) {
